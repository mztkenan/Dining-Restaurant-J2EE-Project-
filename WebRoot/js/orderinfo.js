...
case 2:
    ...
    for (var ai = 0; ai < annius.length; ai++) {
        if (annius[ai].checked) {
            tianxieneirong = annius[ai].value + " , " + $("songhuoshijian" + ai).value;
            var yunfei = 0;
...
function tijiaodingdan()
{
	...
	window.location.href="OrderSuccess.aspx?name=" + name +"&dizhi=" + dizhi + "&youbian=" + youbian + "&phone=" + phone + "&sendway=" + sendway + "&payway=" + payway + "&yunfei=" + yunfei + "&zonger=" + zonger;
}