		...
		<div id="body">
			...
			<div id="info">
				<div id="shouhuoren" class="infoitem">
					<h3>
						收货人信息&nbsp;&nbsp;<a href="javascript:void(0);" id="xiugaia1"
							onclick="xiugaiguanbi(1);">[修改]</a>
					</h3>
					...
					<div class="xuanze" id="xuanzediv1">
						<div>
							<!--  
							<p class="item">
								<label>收&nbsp;货&nbsp;人：</label><input class="txtinput" id="name" /><span
									class="warnspan" id="namespan">请填写收货人姓名！</span>
							</p>
							-->
							<p class="item">
								<label>收货地址：</label><input class="txtinput" id="dizhi" value="" />
								<span class="warnspan" id="dizhispan">请填写收货人详细地址！</span>
							</p>
							<!--  
							<p class="item">
								<label>邮&nbsp;&nbsp;&nbsp;&nbsp;编：</label><input
									class="txtinput" id="youbian" /><span class="warnspan"
									id="youbianspan">请填写收货地邮编！</span>
							</p>
							-->
							<p class="item">
								<label>联系电话：</label><input class="txtinput" id="phone" value=""/>
								<span class="warnspan" id="dianhuaspan">请填写收货人手机或固定电话！</span>
							</p>
							<p class="item">
								<label>备注：</label>
								<input class="txtinput" id="beizhu" value="" />
							</p>
							<p class="anniu">
								<button type="button" onclick="jiancha(1);">确认信息</button>
							</p>
						</div>
					</div>
				</div>
				<div id="songhuofangshi" class="infoitem">
					<h3>
						送货方式&nbsp;&nbsp;
						<!--  
              <a href="javascript:void(0);" id="xiugaia2" onclick="xiugaiguanbi(2);">[修改]</a>
              -->
					</h3>
					...
					<div class="xuanze" id="xuanzediv2">
						<div>
							<p class="radioitem">
								<input type="radio" class="radioinput" name="songhuofangshi"
									value="普通快递送货上门" checked="checked" /> &nbsp;普通快递送货上门
								（支持货到付款）&nbsp;&nbsp;&nbsp;送货上门时间：&nbsp;<select
									id="songhuoshijian0"><option value="时间不限">时间不限</option>
									<option value="周一至周五">周一至周五</option>
									<option value="周六日及假日">周六日及假日</option></select>&nbsp;&nbsp;<span
									id="songhuofeiyong0">运费5元（购物满29元免运费）</span>
							</p>
							<p class="radioitem">
								<input type="radio" class="radioinput" name="songhuofangshi"
									value="加急快递送货上门" /> &nbsp;加急快递送货上门
								（支持货到付款）&nbsp;&nbsp;&nbsp;送货上门时间：&nbsp;<select
									id="songhuoshijian1"><option value="时间不限">时间不限</option>
									<option value="周一至周五">周一至周五</option>
									<option value="周六日及假日">周六日及假日</option></select>&nbsp;&nbsp;<span
									id="songhuofeiyong1">运费10元</span>
							</p>
							<p class="radioitem">
								<input type="radio" class="radioinput" name="songhuofangshi"
									value="邮政特快专递 EMS" /> &nbsp;邮政特快专递 EMS
								（不支持货到付款）&nbsp;送货上门时间：&nbsp;<select id="songhuoshijian2"><option
										value="时间不限">时间不限</option>
									<option value="周一至周五">周一至周五</option>
									<option value="周六日及假日">周六日及假日</option></select>&nbsp;&nbsp;<span
									id="songhuofeiyong2">运费订单总金额的20%,最低16元</span>
							</p>
							<p class="radioitem">
								<input type="radio" class="radioinput" name="songhuofangshi"
									value="自提" /> &nbsp;自提&nbsp;选择自提地点：&nbsp;<select
									id="songhuoshijian3"><option value="清华大学紫荆公寓2号楼西侧">清华大学紫荆公寓2号楼西侧</option>
									<option value="北京大学学一食堂南门">北京大学学一食堂南门</option>
									<option value="中国地质大学东门">中国地质大学东门</option></select>&nbsp;&nbsp;<span
									id="songhuofeiyong3">请在三日内去自提货物，凭收货人身份证取货，代领请出示收货人与提货人的身份证，运费0元</span>
							</p>
							<p class="anniu">
								<button type="button" onclick="jiancha(2);">确认送货方式</button>
							</p>
						</div>
					</div>
				</div>
				<div id="fukuanfangshi" class="infoitem">
					<h3>
						付款方式&nbsp;&nbsp;
						<!--  
              <a href="javascript:void(0);" id="xiugaia3" onclick="xiugaiguanbi(3);">[修改]</a>
              -->
					</h3>
					...
					<div class="xuanze" id="xuanzediv3">
						<div>
							<p class="radioitem">
								<input type="radio" class="radioinput1" name="fukuanfangshi"
									value="网上支付" checked="checked" /> &nbsp;网上支付&nbsp;&nbsp;&nbsp;<span
									id="fukuanspan0">请在提交订单后及时进行网上支付&nbsp;&nbsp;开户名&nbsp;：&nbsp;北京当当科文电子商务有限公司&nbsp;
									开户行&nbsp;:&nbsp;光大银行北京安定门支行&nbsp;账号&nbsp;:&nbsp;087511120100302167678</span>
							</p>
							<p class="radioitem">
								<input type="radio" class="radioinput1" name="fukuanfangshi"
									value="货到付款" /> &nbsp;货到付款&nbsp;&nbsp;&nbsp;<span
									id="fukuanspan1">请您在收货时向送货员支付订单款项（温情提示：自备零钱）</span>
							</p>
							<p class="radioitem">
								<input type="radio" class="radioinput1" name="fukuanfangshi"
									value="邮局汇款 " /> &nbsp;邮局汇款&nbsp;&nbsp;&nbsp;<span
									id="fukuanspan2">请您在汇款单的 请按汇款种类 中选择
									商务汇款，商户客户号为：110700150&nbsp;到款时间一般为2-7个工作日,所购商品将在款项到达当当网帐户后发出</span>
							</p>
							<p class="radioitem">
								<input type="radio" class="radioinput1" name="fukuanfangshi"
									value="银行转帐 " /> &nbsp;银行转帐&nbsp;&nbsp;&nbsp;<span
									id="fukuanspan3">到款时间一般为1-5个工作日&nbsp;&nbsp;开户名&nbsp;：&nbsp;北京当当科文电子商务有限公司&nbsp;
									开户行&nbsp;:&nbsp;光大银行北京安定门支行&nbsp;账号&nbsp;:&nbsp;087511120100302167678</span>
							</p>
							<p class="anniu">
								<button type="button" onclick="jiancha(3);">确认付款方式</button>
							</p>
						</div>
					</div>
				</div>
